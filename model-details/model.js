...
const PARAM_FIELDS = ["temperature", "topP", "topK", "numPredict"];
const PRESETS = {
  precise: { temperature: 0.3, topP: 0.8, topK: 20, numPredict: 512 },
  balanced: { temperature: 0.8, topP: 0.9, topK: 40, numPredict: 512 },
  creative: { temperature: 1.0, topP: 0.95, topK: 80, numPredict: 768 }
};
let currentExamples = [];
