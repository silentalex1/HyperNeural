...
echo [4/4] Installing command shortcuts...
if exist ".hyperneural" (
    xcopy ".hyperneural\*.bat" "%USERPROFILE%\.hyperneural\" /Y
    echo Command shortcuts installed to %USERPROFILE%\.hyperneural
)
...
echo   hypertrain.bat train --name "MyAI" --description "..." --base "meta-llama/Llama-3.1-8B"
echo.
